...
4. the [cairn/](./cairn) folder, which follows the [Cairn](https://github.com/pimalaya/cairn) convention: `spec/` is the current design of the daemon, `changes/` holds in-flight proposals, and `log/` the dated history. `AGENTS.md` at the root is the activation stanza.
